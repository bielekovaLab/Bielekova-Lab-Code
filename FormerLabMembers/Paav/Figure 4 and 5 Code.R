...
adap.immunity.csf <- ggarrange(CSF.CD3_Abs,CSF.TCD3_Eventsr,CSF.CD4T_Abs,
                                CSF.TCD4_Eventsr_adjust,CSF.CD8T_Abs,CSF.HLAdrCD8T_Abs,
                                CSF.Bcell_Abs,CSF.BCD19_Eventsr_adjust,
                                labels = c("A"),
                               ncol = 8, nrow = 1)
setwd("/Users/paavali/Dropbox/NIH/IPT Papers and Codes/Edits made on Mac/Figure 3-5")
jpeg("adap.immunity.csf.jpeg",width = 22.4,height=3.9,units="in",res=600)
...
innate.immunity.csf<- ggarrange(CSF.CD14mono_Eventsr,CSF.NK_Abs,
                                ...
                                ncol = 8, nrow = 1)
setwd("/Users/paavali/Dropbox/NIH/IPT Papers and Codes/Edits made on Mac/Figure 3-5")
jpeg("innate.immunity.csf.jpeg",width = 22.4,height=3.9,units="in",res=600)
...
other.csf<- ggarrange(CSF.CD19_MonocyteR_adjust,
                      ...
                      ncol = 8, nrow = 1)
setwd("/Users/paavali/Dropbox/NIH/IPT Papers and Codes/Edits made on Mac/Figure 3-5")
jpeg("other.csf.jpeg",width = 22.4,height=3.9,units="in",res=600)
...
csf.disease.duration <- ggarrange(DD.CSF.CD3_Abs,
                      ...
                      ncol = 8, nrow = 2)
setwd("/Users/paavali/Dropbox/NIH/IPT Papers and Codes/Edits made on Mac/Figure 3-5")
jpeg("csf.disease.duration.jpeg",width = 22.4,height=7.8,units="in",res=600)
...
adap.immunity.blood <- ggarrange(Blood.TCD3_Eventsr_adjust,
                                 ...
                                 ncol = 6, nrow = 1)
setwd("/Users/paavali/Dropbox/NIH/IPT Papers and Codes/Edits made on Mac/Figure 3-5")
jpeg("adap.immunity.blood.jpeg",width = 16.6,height=3.9,units="in",res=600)
...
innate.immunity.blood<- ggarrange(Blood.NK_Abs_adjust,
                                  ...
                                  ncol = 6, nrow = 1)
setwd("/Users/paavali/Dropbox/NIH/IPT Papers and Codes/Edits made on Mac/Figure 3-5")
jpeg("innate.immunity.blood.jpeg",width = 16.6,height=3.9,units="in",res=600)
annotate_figure(innate.immunity.blood,  top = text_grob("Innate Immunity in Blood", face = "bold", size = 14))
dev.off()


blood.disease.duration <- ggarrange(DD.blood.CD4_CD3R,
                                    DD.blood.CD8_CD3R_adjust,
                                    DD.blood.CD4_CD8R_adjust,
                                  labels = c("C"),
                                  ncol = 6, nrow = 1)
setwd("/Users/paavali/Dropbox/NIH/IPT Papers and Codes/Edits made on Mac/Figure 3-5")
jpeg("blood.disease.duration.jpeg",width = 16.6,height=3.9,units="in",res=600)
